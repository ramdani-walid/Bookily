# Generated by Django 3.0.2 on 2020-01-22 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_postal', models.SmallIntegerField(blank=True, db_column='CODE_POSTAL', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure_idstructure', models.ForeignKey(db_column='STRUCTURE_idSTRUCTURE', on_delete=django.db.models.deletion.DO_NOTHING, to='bookili.Structure')),
                ('userpropr_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'STAFF',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debut_service', models.TimeField(blank=True, db_column='DEBUT_SERVICE', null=True)),
                ('fin_service', models.TimeField(blank=True, db_column='FIN_SERVICE')),
                ('structure_idstructure', models.ForeignKey(db_column='STRUCTURE_idSTRUCTURE', on_delete=django.db.models.deletion.DO_NOTHING, to='bookili.Structure')),
                ('userpropr_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_idclient', models.ForeignKey(db_column='CLIENT_idCLIENT', on_delete=django.db.models.deletion.DO_NOTHING, to='bookili.Client')),
                ('structure_idstructure', models.ForeignKey(db_column='STRUCTURE_idSTRUCTURE', on_delete=django.db.models.deletion.DO_NOTHING, to='bookili.Structure')),
            ],
            options={
                'db_table': 'RDV',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_idstaff', models.ForeignKey(db_column='STAFF_idSTAFF', on_delete=django.db.models.deletion.DO_NOTHING, to='bookili.Staff')),
            ],
            options={
                'db_table': 'SERVIR',
                'managed': True,
